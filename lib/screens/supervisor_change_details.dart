...
class SupervisorChangeDetails extends StatelessWidget {
  const SupervisorChangeDetails({
    Key? key,
  }) : super(key: key);
                ...
                Container(
                  ...
                  child: DataTable(columns: const <DataColumn>[
                    ...
                    DataRow(cells: <DataCell>[
                      ...
                      DataCell(Text("Dr.Fakher eldeen mohamed ")),
                    ]),
                    DataRow(cells: <DataCell>[
                      DataCell(
                        Text(
                    ...
                    DataRow(cells: <DataCell>[
                      ...
                      DataCell(Text("Dr.Othman alnour ")),
                    ]),
                    DataRow(cells: <DataCell>[
                      DataCell(Text(
                    ...
                    DataRow(cells: <DataCell>[
                      ...
                      DataCell(Text(
                          "Reseacher had accomplished about 30% of his researsh  ")),
                    ]),
                    DataRow(cells: <DataCell>[
                      DataCell(Text(
                      ...
                      DataCell(Text(
                          "Reseacher had not accomplished about 70% of his researsh  ")),
                    ]),
                    DataRow(cells: <DataCell>[
                      DataCell(Text(
                        "Request state  ",
