...
class TitleOfSearchchangeDetails extends StatelessWidget {
  const TitleOfSearchchangeDetails({
    Key? key,
  }) : super(key: key);
              ...
              children: [
                Container(
                  ...
                  child: DataTable(columns: const <DataColumn>[
                    DataColumn(
                      label: Text("Applicant of Request ",
                          style: TextStyle(
                            fontWeight: FontWeight.bold,
                    ...
                    DataRow(cells: <DataCell>[
                      ...
                      DataCell(Text("Software engneering approches ")),
                    ]),
                    DataRow(cells: <DataCell>[
                      DataCell(Text(
                        "New title  ",
                      ...
                      DataCell(Text("Securety challenges  ")),
                    ]),
                    DataRow(cells: <DataCell>[
                      DataCell(Text(
                        "Supervisor Approval",
